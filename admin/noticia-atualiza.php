    ...
    <article class="col-12 bg-white rounded shadow my-1 py-4">
        ...
        <form class="mx-auto w-75" action="" method="post" id="form-atualizar" name="form-atualizar" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input class="form-control" value="<?=$dados['titulo']?>" required type="text" id="titulo" name="titulo">
            </div>
            ...
            <div class="mb-3">
                ...
                <input class="form-control" type="text"  value="<?=$dados['imagem']?>" id="imagem-existente" name="imagem-existente" readonly>
            </div>
